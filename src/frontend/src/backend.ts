...
export class Backend implements backendInterface {
    ...
    async getTrendingTutorials(): Promise<Array<Tutorial>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTrendingTutorials();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTutorialsByCategory(arg0: string): Promise<Array<Tutorial>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTutorialsByCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
